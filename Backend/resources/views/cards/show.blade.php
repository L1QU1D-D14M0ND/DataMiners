            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <p><strong>Credits Unlock:</strong> {{ number_format($card->credits_unlock) }}</p>
                            <p><strong>Created At:</strong> {{ $card->created_at->format('M d, Y H:i') }}</p>
                        </div>
                    </div>
                </div>
                <div class="card-footer">
                    <a href="{{ route('cards.edit', $card) }}" class="btn btn-custom-warning">Edit</a>
                    ...
                    <a href="{{ route('cards.index') }}" class="btn btn-custom-secondary">Back to Cards</a>
                </div>
            </div>
        </div>
    </div>
