        ...
        <div class="col-md-8 offset-md-2">
            ...
            <form action="{{ route('cards.update', $card) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('credits_unlock') is-invalid @enderror" id="credits_unlock" name="credits_unlock" value="{{ old('credits_unlock', $card->credits_unlock) }}" min="0">
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-custom-primary">Update Card</button>
                    <a href="{{ route('cards.show', $card) }}" class="btn btn-custom-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
