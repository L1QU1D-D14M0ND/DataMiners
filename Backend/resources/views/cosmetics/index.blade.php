...
<div class="container" style="margin-top: 2rem;">
    <div class="row mb-4">
        <div class="col-md-6">
            <h1 class="text-center">Cosmetics</h1>
        </div>
        <div class="col-md-6 text-end">
            <a href="{{ route('cosmetics.create') }}" class="btn btn-custom-success">+ Create Cosmetic</a>
        </div>
    </div>
                    ...
                    <div class="card h-100 border card-custom">
                        <div class="card-body">
                            ...
                            <dl class="row mb-3">
                                ...
                                <dd class="col-sm-7">{{ number_format($cosmetic->credits_unlock) }}</dd>
                            </dl>
                        </div>
                        <div class="card-footer bg-white border-top" style="display: flex; gap: 0.5rem; flex-wrap: wrap;">
                            <a href="{{ route('cosmetics.show', $cosmetic) }}" class="btn btn-sm btn-custom-info">View</a>
                            <a href="{{ route('cosmetics.edit', $cosmetic) }}" class="btn btn-sm btn-custom-warning">Edit</a>
