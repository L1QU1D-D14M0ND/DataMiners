    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            ...
            <form action="{{ route('cosmetics.update', $cosmetic) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('currency_a_unlock') is-invalid @enderror" id="currency_a_unlock" name="currency_a_unlock" value="{{ old('currency_a_unlock', $cosmetic->currency_a_unlock) }}" min="0">
                ...
                <div class="mb-3">
                    <button type="submit" class="btn btn-primary">Update Cosmetic</button>
                    <a href="{{ route('cosmetics.show', $cosmetic) }}" class="btn btn-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
