...
import { Volume2, VolumeX, Sun, Moon, Settings, X, Home } from "lucide-react"
...
export function SettingsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-auto">
      ...
      <div className="relative ark-card scanlines w-full max-w-sm overflow-hidden">
        <div className="flex items-center justify-between p-4 border-b border-white/10">
          <h2 className="font-serif text-lg text-white italic">Settings</h2>
          <button onClick={onClose} className="p-2 ark-button" aria-label="Close settings">
            <X className="w-4 h-4" />
          </button>
        </div>
